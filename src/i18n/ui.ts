...
const en: I18nStrings = {
  ...
  blogNavRecent: "Recent",
  blogNavCategories: "Categories",
  blogNavTags: "Tags",
  blogNavArchives: "Archives",
  blogSidebarRecent: "Recent Updates",
  blogSidebarStats: "Site Stats",
...
const zh: I18nStrings = {
  ...
  blogBack: "← 返回主页",
  blogNavRecent: "近期发布",
  blogNavCategories: "分类",
  blogNavTags: "标签",
  blogNavArchives: "归档",
  blogSidebarRecent: "最近更新",
  blogSidebarStats: "网站统计",
  blogCategories: "分类",
  blogTags: "标签",
  blogArchives: "归档",
  blogReadMore: "阅读更多 →",
